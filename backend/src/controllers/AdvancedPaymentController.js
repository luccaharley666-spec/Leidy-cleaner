...
router.post('/apple-pay', async (req, res) => {
  try {
    ...
    const payment = await paymentService.processApplePayment(bookingId, amount, applePayToken);
...
router.post('/google-pay', async (req, res) => {
  try {
    ...
    const payment = await paymentService.processGooglePayment(bookingId, amount, googlePayToken);
...
router.post('/subscriptions/:subscriptionId/billing', async (req, res) => {
  try {
    ...
    const payment = await paymentService.processBillingCycle(subscriptionId);
